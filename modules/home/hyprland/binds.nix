...
in {
  wayland.windowManager.hyprland.settings = {
    bindd =
      ...
      ++ [
        # ============= WORKSPACE OVERVIEW =============
        "$modifier CTRL,D, Toggle Dock, exec, nwg-dock-hyprland"
        ...
        "$modifier,Z, Web Browser, exec, zen-beta"
        ...
        "$modifier,SPACE, Switch Keyboard Layout, exec, hyprctl switchxkblayout current next"
        "$modifier SHIFT,C, Exit/Logout of Hyprland, exit,"
        "$modifier, L, Hyprland Screen Lock, exec, hyprlock"
        "$modifier SHIFT, H, System Hibernate, exec, systemctl hibernate"
        ...
        "$modifier SHIFT,CAPS , Move to Special, movetoworkspace, special"
        "$modifier, CAPS, Toggle Special, togglespecialworkspace"
